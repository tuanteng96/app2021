...
export default class extends React.Component {
    ...
    render() {
        ...
        return (
            <Page noToolbar name="voucher" ptr onPtrRefresh={this.loadMore.bind(this)}>
                <Navbar>
                    ...
                    <Subnavbar className="cardservice-tab-head">
                        <div className="cardservice-title">
                            <Link noLinkClass tabLink="#tome" tabLinkActive>Cho bạn</Link>
                            <Link noLinkClass tabLink="#toall">Áp dụng chung</Link>
                            <Link noLinkClass tabLink="#toaffiliate">Affiliate</Link>
                        </div>
                    </Subnavbar>
                </Navbar>
                    ...
                    <Tabs>
                        <Tab id="tome" tabActive>
                            <div className="page-voucher__list">
                                {voucherMe && voucherMe.length > 0 ? voucherMe.map((item, index) => (
                                    <div className="page-voucher__list-item" key={index}>
                                        ...
                                        <div className="voucher-text">
                                            ...
                                            <ul>
                                                <li><span>Ưu đãi</span><span>{item.Discount}%</span></li>
                                                <li>HSD : Còn {checkDateDiff(item.EndDate)} ngày </li>
                                            </ul>
                                        </div>
                                    </div>
                                )) : (
                        ...
                        <Tab id="toall">
                            <div className="page-voucher__list">
                                {VoucherAll && VoucherAll.length > 0 ? VoucherAll.map((item, index) => (
                                    <div className="page-voucher__list-item" key={index}>
                                        <div className="voucher-icon">
                                            <div className="voucher-icon__text">
                                                <div className="date">
                        ...
                        <Tab id="toaffiliate">
                            <div className="page-voucher__list">
                                {VoucherAff && VoucherAff.length > 0 ? VoucherAff.map((item, index) => (
                                    <div className="page-voucher__list-item" key={index}>
                                        <div className="voucher-icon">
                                            <div className="voucher-icon__text">
                                                <div className="date">
