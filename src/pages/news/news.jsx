  ...
  getDateVietnamese = () => {
    ...
    return (
      <div className="page-news__header-date">
        <div className="date">{days[day]}, {date} tháng {months[month]}</div>
        <h3>Hôm nay</h3>
      </div>
    )
  }
        ...
        <div className="page-render">
            ...
            return (
              <div className="page-news__dear" key={item.ID}>
                <div className="page-news__dear-img">
                  <a href="/">
                    <img src={SERVER_APP + item.Thumbnail_web} alt={item.Title} />
                  </a>
                </div>
          ...
          <div className="page-news__list">
            <div className="page-news__list-head">
              <h5>Tin tức mới</h5>
              <div className="all">
                <Link href="/news-list/">Xem tất cả <i className="las la-angle-right"></i></Link>
              </div>
            </div>
            <div className="page-news__list-ul">
              <Slider {...settingsNews}>
                {arrNews && arrNews.map((item, index) => {
                  ...
                  return (
                    <div className="page-news__list-item" key={item.ID} style={this.handStyle()}>
